...
items = {
    ...
    'map storage cabinet': myItem( 'map storage cabinet', 0x285C, 0x0000, 'furniture', None ),
    'skill scroll storage bookshelf': myItem( 'skill scroll storage bookshelf', 0x0A9A, 0x0501, 'furniture', None ),
    ...
    'wooden bench (east/west)': myItem( 'wooden bench', 0x0B2C, 0x0000, 'furniture', None ),
